---
title: "GBrain: The Complete Guide for Web3 Builders"
description: GBrain is an open-source AI memory system by Garry Tan that gives AI agents persistent long-term memory, hybrid search, and autonomous dream cycles — here's how Web3 builders can use it for protocol research, investment management, and community knowledge.
date: 2026-04-22
category: AI & Web3
...
- **Installation Guide**: [INSTALL_FOR_AGENTS.md](https://github.com/garrytan/gbrain/blob/master/INSTALL_FOR_AGENTS.md)
- **Architecture Docs**: [docs/GBRAIN_V0.md](https://github.com/garrytan/gbrain/blob/master/docs/GBRAIN_V0.md)
- **MIT License**: Free to use, modify, and deploy

### Integration Guides

- **OpenClaw Setup**: [docs/guides/executive-assistant.md](https://github.com/garrytan/gbrain/blob/master/docs/guides/executive-assistant.md)
